    ...
    'bathroom': {
        'direct': {
            'keywords': [
                ...
                'the guest bathroom', 'the shower room', 'the private restroom'
            ],
            'patterns': [
                'I\'m heading to [KW]', 'Can you guide me to [KW]?', 'Let\'s go to [KW]',
                'Show me the way to [KW]', 'I need to visit [KW]', 'Take me to [KW]',
                'I need to use [KW]', 'Let\'s check [KW]', 'I will open the door to [KW]',
                'Can we go to [KW]?', 'I\'m walking into [KW]', 'Let\'s clean up [KW]'
            ]
        },
        'indirect': {
            # 제공해주신 오브젝트 반영: 세면대, 거울, 변기, 샤워기, 욕조, 수건걸이, 비누 디스펜서, 칫솔꽂이 등
            'keywords': [
                'the bathroom sink', 'the bathroom mirror', 'the toilet', 'the shower',
                'the bathtub', 'the towel rack', 'the soap dispenser', 'the toothbrush holder',
                'the bathroom cabinet', 'the shower curtain', 'the floor mat'
            ],
            'patterns': [
                'I want to use [KW]', 'I am going to wash my hands at [KW]', 'Let\'s clean [KW]',
                'I\'m standing right by [KW]', 'Can you wipe [KW]?', 'I need to check [KW]',
                'I\'m looking at myself in [KW]', 'Let\'s move [KW]', 'I will set up [KW]',
                'Can you help me with [KW]?', 'I\'m freshening up next to [KW]', 'I am stepping onto [KW]'
            ]
        },
        'ambiguous': {
            'keywords': [
                'the place where I wash my hands', 'the room used for freshening up',
                'where I clean up before going out', 'the space with the mirror and sink',
                'where I take care of personal hygiene',
                'the room where I can rinse off', 'where I get ready in the morning',
                'the private room for cleaning up'
            ],
            'patterns': [
                'I am going to [KW]', 'Let\'s visit [KW]', 'Can you guide me to [KW]?',
                'I\'m heading towards [KW]', 'Take me to [KW]', 'I think I need to be in [KW]',
                'Let\'s start our day in [KW]', 'I\'m walking into [KW]', 'I feel like spending a moment in [KW]'
            ]
        }
    }
}
